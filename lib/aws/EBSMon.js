...
class EBSMon extends AWSMon {
    ...
    poll(now) {
        ...
        // demographic/aggregate information and track changes. The
        // second call gets the specific volume status of each volume
        // and emits any non-ok status as a metric.
